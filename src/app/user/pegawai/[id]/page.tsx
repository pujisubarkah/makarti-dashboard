  ...
  return (
    <div className="w-full max-w-4xl mx-auto p-4 border rounded-md bg-gray-50">
      <div className="flex items-center justify-between mb-6">
        <Link href="/user/pegawai" className="px-4 py-2 bg-gray-100 text-gray-700 rounded hover:bg-gray-200 transition">← Kembali</Link>
        {!editMode && (
      ...
      <div id="data-pribadi" className="w-full mt-8 p-2 border rounded-md bg-gray-50">
        ...
        <div className="border border-gray-300 rounded-md bg-gray-50 mt-2">
